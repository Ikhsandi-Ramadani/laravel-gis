...
(function () {
  let strokeColor, gradientColor, shadeColor, axisColor, headingColor;

  if (isDarkStyle) {
    strokeColor = config.colors_dark.cardColor;
    gradientColor = config.colors_dark.cardColor;
    ...
    gradientColor = config.colors.white;
