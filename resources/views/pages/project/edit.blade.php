                        ...
                        <select name="pengawas_id" class="form-control" required>
                            @foreach ($pengawass as $pengawas)
                                <option value="{{ $pengawas->id }}"
                                    {{ $project->pengawas_id == $pengawas->id ? 'selected' : '' }}>{{ $pengawas->nama }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" value="{{ $project->kecamatan }}" name="kecamatan"
                                required />
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <label class="form-label">Type Bangunan</label>
                            <select name="type_id" class="form-control" required>
                                @foreach ($types as $type)
                                    <option value="{{ $type->id }}"
                                        {{ $type->id == $project->type_id ? 'selected' : '' }}>{{ $type->nama }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
